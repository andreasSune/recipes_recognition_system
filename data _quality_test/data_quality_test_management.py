...
def run_strategy_1_pipeline(
    ...
    Args:
        ...
        graphs_csv: Chemin vers le fichier des graphes
        nombre_recettes: Nombre de recettes à échantillonner
        output_dir: Répertoire de sortie
        openrouter_api_key: Clé API OpenRouter pour ré-annotation LLM
        model_name: Nom du modèle OpenRouter à utiliser
        manual_annotations_excel: Chemin du fichier Excel rempli (si déjà fait)
    """
    print(f"\n{'#'*80}")
    print(f"# PIPELINE STRATÉGIE 1 - VALIDATION PAR ANNOTATIONS MANUELLES")
    print(f"# VERSION MODIFIÉE - 2 VARIANTES")
    print(f"{'#'*80}\n")
    ...
    # Si annotations manuelles déjà faites, charger
    if manual_annotations_excel:
        print("\nÉTAPE 5/7 : Chargement des annotations manuelles...")
        manual_df = load_manual_annotations(manual_annotations_excel)
        
        # Étape 6 : Comparaison tripartite
        print("\nÉTAPE 6/7 : Comparaison tripartite...")
        metrics_p, metrics_i = perform_tripartite_comparison(manual_df, reannotated_df, output_dir)
        
        # Étape 7 : Visualisations et rapport
        print("\nÉTAPE 7/7 : Génération visualisations et rapport...")
        ...
        print(f"   - Ré-annotations LLM : {reannotation_file}")
        ...
        print(f"4. Relancer le pipeline avec manual_annotations_excel='{excel_file}'")
